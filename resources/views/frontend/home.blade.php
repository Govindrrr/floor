    ...
    <section>
        <div class="container py-10">
            <div class="flex justify-between items-center">
                ...
                <div class="">
                    <h1 class="text-2xl primary ">Featured Restaurent/Store</h1>
                    <p class="">The nearest restaurant/store to your location</p>
                </div>
                <a href="{{route('shops')}}" class="primary">view all <i class="fa-solid fa-arrow-right"></i></a>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10 py-5">
                @foreach ($vendors as $vendor)
                    <div class="border hover:shadow-lg duration-300">
                        <a href="{{route('vendor',$vendor->id)}}" class="">
                            <img class="h-[240px] w-full object-cover"
                                src="{{ asset(Storage::url($vendor->shop->logo)) }}" alt="xxx">
        ...
        <div class="bg-white py-10">
            <div class="container ">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{route('products')}}" class="primary">view all <i class="fa-solid fa-arrow-right"></i></a>
                </div>
